...
import type { AudienceValidationV1 } from "@/lib/campaigns/types-v1"

interface ValidationPanelV1Props {
  validation: AudienceValidationV1
}

export function ValidationPanelV1({ validation }: ValidationPanelV1Props) {
  return (
